...
Haiti_far$Location = as.factor("Haiti Ambient")
Haiti_near$Location = as.factor("Haiti AR")
Bahamas_far$Location = as.factor("Bahamas Ambient")
Bahamas_near$Location = as.factor("Bahamas AR")
...
corr.plots = ggpairs(all_grouped, columns = c("Shoot.growth","C.production", "Seagrass.P",
                                              "Seagrass.N", "SLA", "LAI", "Seagrass.C13"
